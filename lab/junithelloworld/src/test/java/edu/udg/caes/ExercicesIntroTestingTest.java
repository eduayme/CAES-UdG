...
public class ExercicesIntroTestingTest {
    ...
    // New tests
    @Test
    public void solve_testFindLast(){
        final int result = ExercicesIntroTesting.findLast(new int []{2, 3, 5}, 4);
        assertEquals(result, -1);
    }

    @Test
    public void solve_testLastZero(){
        final int result = ExercicesIntroTesting.lastZero(new int []{0, 1, 2});
        assertEquals(result, 0);
    }

    @Test
    public void solve_testCountPositive(){
        final int result = ExercicesIntroTesting.countPositive(new int []{-4, 2, 1, 2});
        assertEquals(result, 3);
    }

    @Test
    public void solve_testOddOrPos(){
